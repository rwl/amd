 ...
 */
//public class Damd_2 extends Damd_internal {
 ...
 *
 * @param n A is n-by-n, where n > 0
 * @param Pe Pe [0..n-1]: index in Iw of row i on input
 * @param Iw workspace of size iwlen. Iw [0..pfree-1]
 * holds the matrix on input
 * @param Len Len [0..n-1]: length for row/column i on input
 * @param iwlen length of Iw. iwlen >= pfree + n
 * @param pfree Iw [pfree ... iwlen-1] is empty on input
 * @param Nv size-n, the size of each supernode on output
 * @param Next size-n, the output inverse permutation
 * @param Last size-n, the output permutation
 * @param Head size-n
 * @param Elen size-n, the size columns of L for each supernode
 * @param Degree size-n
 * @param W size-n

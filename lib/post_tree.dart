...
/*int post_tree (int root, int k, List<int> Child,
		final List<int> Sibling, List<int> Order, List<int> Stack)
{
 ...
 */
int post_tree (int root, int k, List<int> Child,
		final List<int> Sibling, List<int> Order, List<int> Stack, [int nn=0])
{
	int f, head, h, i ;

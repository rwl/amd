 ...
 */
const int AMD_CONTROL = 5;

/**
 * size of Info array
 */
const int AMD_INFO = 20;
 ...
 */
const int AMD_DENSE = 0;

/**
 * do aggressive absorption if Control [1] != 0
 */
const int AMD_AGGRESSIVE = 1;
...
const String AMD_DATE = "Jan 25, 2011";
int AMD_VERSION_CODE(int main, int sub) => ((main) * 1000 + (sub));
const int AMD_MAIN_VERSION = 2;
const int AMD_SUB_VERSION = 2;
const int AMD_SUBSUB_VERSION = 2;
final int AMD_VERSION = AMD_VERSION_CODE(AMD_MAIN_VERSION, AMD_SUB_VERSION);
